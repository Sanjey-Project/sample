    ...
    foreach($resultsResult['data']['hits']['hits'] as $hit) {
        ...
        if(!isset($uniqueStudents[$studentId])) {
            ...
            if($studentResult['success'] && isset($studentResult['data']['_source'])) {
                $student = $studentResult['data']['_source'];
...
$cnt=1;
foreach($uniqueStudents as $studentId => $result)
{   ?>
<tr>
 <td><?php echo htmlentities($cnt);?></td>
                                                            <td><?php echo htmlentities($result['studentName']);?></td>
                                                            <td><?php echo htmlentities($result['rollId']);?></td>
                                                            <td><?php echo htmlentities($result['className']);?>(<?php echo htmlentities(isset($result['classNameNumeric']) ? $result['classNameNumeric'] : '');?>-<?php echo htmlentities($result['section']);?>)</td>
                                                            <td><?php echo htmlentities($result['regDate']);?></td>
<td>
<a  class="btn btn-primary" href="edit-result.php?stid=<?php echo htmlentities($studentId);?>">Update </a> 
<a  class="btn btn-danger" href="delete-result.php?stid=<?php echo htmlentities($studentId);?>">Delete </a> 
