...
$existingSubject = $es->get(INDEX_SUBJECTS, $sid);
if($existingSubject['success'] && isset($existingSubject['data']['_source'])) {
    $existingData = $existingSubject['data']['_source'];
    ...
    $updateResult = $es->index(INDEX_SUBJECTS, $sid, $updateDoc);
...
<div class="alert alert-success left-icon-alert" role="alert">
 ...
 <?php
$sid=intval($_GET['subjectid']);
// Get subject data from Elasticsearch
$subjectResult = $es->get(INDEX_SUBJECTS, $sid);
$cnt=1;
if($subjectResult['success'] && isset($subjectResult['data']['_source']))
{
    $result = $subjectResult['data']['_source'];
    ?>                                               
