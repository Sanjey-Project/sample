...
if($checkResult['success'] && isset($checkResult['data']['hits']['hits'][0])) {
    $adminData = $checkResult['data']['hits']['hits'][0]['_source'];
    ...
    $updateResult = $es->index(INDEX_ADMINISTRATORS, $adminId, $updateDoc);
